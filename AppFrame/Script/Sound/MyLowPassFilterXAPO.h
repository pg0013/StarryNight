...
#define EFFECT_PARAMS 3
	...
	/**
	 * @class	MyLowPassFilterXAPO :public CXAPOParametersBase
	 *
	 * @brief	ローパスパスフィルターのXAPOFX
	 * @detail	遮断周波数の上限がサンプリング周波数の1/2
	 */
	class __declspec(uuid("{2B54BE76-BAF5-4A22-83F7-AB1B679EED63}"))
		MyLowPassFilterXAPO :public CXAPOParametersBase
	{
	public:
		MyLowPassFilterXAPO();
		~MyLowPassFilterXAPO() {};
